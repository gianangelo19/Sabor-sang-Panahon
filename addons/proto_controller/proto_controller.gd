...
## Name of Input Action to interact with focused objects or NPCs.
...
@onready var interact_prompt: Label = $InteractionUI/Prompt
...
func _ready() -> void:
	...
	audio_walk.stream = load("res://assets/audio/retro_filipino_pack/walking_asphalt_realistic.wav")
	audio_walk.bus = "SFX"
...
func find_interactable(node: Object) -> Node:
