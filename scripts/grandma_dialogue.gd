...
const FIRST_CONVERSATION: Array[Dictionary] = [
	...
	{"speaker": "Grandma", "text": "I remember bowls of hot broth and soft noodles. There was plenty of garlic, and something crisp scattered on top.", "portrait": GRANDMA_PORTRAIT},
...
const REPEAT_CONVERSATION: Array[Dictionary] = [
	...
	{"speaker": "Grandma", "text": "Hot broth, soft noodles, plenty of garlic, and something crisp scattered on top.", "portrait": GRANDMA_PORTRAIT},
...
func _on_dialogue_finished() -> void:
	if not _conversation_completed:
		...
		GameState.add_clue("Grandma remembers hot broth, soft noodles, garlic, and a crisp topping.")
