...
const RING_TEXTURE: Texture2D = preload(
	"res://minigames-main/chicharon_beat/assets/gameplay/takeout_indicator_ring.png"
)

const ARROW_TEXTURE: Texture2D = preload(
	"res://minigames-main/chicharon_beat/assets/gameplay/takeout_indicator_arrow.png"
)

const PULSE_TEXTURE: Texture2D = preload(
	"res://minigames-main/chicharon_beat/assets/gameplay/beat_pulse_circle.png"
)
