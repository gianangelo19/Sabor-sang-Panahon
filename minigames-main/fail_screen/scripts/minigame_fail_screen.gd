...
const GAME_OVER_TEXTURE_PATH: String = (
	"res://minigames-main/fail_screen/assets/ui/game_over_title.png"
)

const RETRY_TEXTURE_PATH: String = (
	"res://minigames-main/fail_screen/assets/ui/retry_button.png"
)

const EXIT_TEXTURE_PATH: String = (
	"res://minigames-main/fail_screen/assets/ui/exit_button.png"
)


const FAIL_AUDIO_ROOT: String = (
	"res://minigames-main/fail_screen/assets/audio/"
)
