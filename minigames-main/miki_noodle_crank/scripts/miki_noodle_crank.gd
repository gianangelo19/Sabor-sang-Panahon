...
const ENDING_COLLECTIBLE: Texture2D = preload(
	"res://minigames-main/ending_sequence/assets/collectibles/collectible_miki_noodles_bag.png"
)
...
const TIMER_FRAME_PATH: String = (
	"res://minigames-main/miki_noodle_crank/assets/ui/"
...
const NOODLE_DROP_SHADOW_PATH: String = (
	"res://minigames-main/miki_noodle_crank/assets/effects/"
...
const MUSIC_PATH: String = (
	"res://minigames-main/miki_noodle_crank/assets/audio/music/"
	+ "bgm_miki_crank_loop.ogg"
)

const AMBIENCE_PATH: String = (
	"res://minigames-main/miki_noodle_crank/assets/audio/ambience/"
	+ "amb_market_machine_loop.ogg"
)

const CRANK_01_PATH: String = (
	"res://minigames-main/miki_noodle_crank/assets/audio/sfx/"
...
const UI_HOVER_PATH: String = (
	"res://minigames-main/miki_noodle_crank/assets/audio/ui/"
	+ "sfx_ui_hover.wav"
)
