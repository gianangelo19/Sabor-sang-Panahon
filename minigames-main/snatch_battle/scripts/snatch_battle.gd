...
const ENDING_COLLECTIBLE := preload(
	"res://minigames-main/ending_sequence/assets/collectibles/collectible_meat_set_bag.png"
)
...
const BASKET_TEXTURE := preload(
	"res://minigames-main/snatch_battle/assets/ui/basket_ui_topdown.png"
)
const TRASH_TEXTURE := preload(
	"res://minigames-main/snatch_battle/assets/ui/trashcan_ui_topdown.png"
)
const ORDER_TEXTURE := preload(
	"res://minigames-main/snatch_battle/assets/ui/order_board_required_meats_vertical.png"
)
const LEFT_HAND_TEXTURE := preload(
	"res://minigames-main/snatch_battle/assets/hands/npc_arm_left.png"
)
const RIGHT_HAND_TEXTURE := preload(
	"res://minigames-main/snatch_battle/assets/hands/npc_arm_right.png"
)

const MEAT_TEXTURES: Dictionary = {
	"belly": preload("res://minigames-main/snatch_battle/assets/meats/meat_required_belly.png"),
	"liver": preload("res://minigames-main/snatch_battle/assets/meats/meat_required_liver_atay.png"),
	"spleen": preload("res://minigames-main/snatch_battle/assets/meats/meat_required_spleen_lapay.png"),
	"pork_chop": preload("res://minigames-main/snatch_battle/assets/meats/meat_extra_pork_chop.png"),
	"pork_hock": preload("res://minigames-main/snatch_battle/assets/meats/meat_extra_pork_hock.png"),
	"pork_ribs": preload("res://minigames-main/snatch_battle/assets/meats/meat_extra_pork_ribs.png"),
	"pork_shoulder": preload("res://minigames-main/snatch_battle/assets/meats/meat_extra_pork_shoulder.png"),
	"bone_cut": preload("res://minigames-main/snatch_battle/assets/meats/meat_bad_bone_cut.png"),
	"fat_scraps": preload("res://minigames-main/snatch_battle/assets/meats/meat_bad_fat_scraps.png"),
	"old_meat": preload("res://minigames-main/snatch_battle/assets/meats/meat_bad_old_meat.png"),
}

const MUSIC := preload(
	"res://minigames-main/snatch_battle/assets/audio/music/bgm_snatch_battle_loop.ogg"
)
const AMBIENCE := preload(
	"res://minigames-main/snatch_battle/assets/audio/ambience/amb_meat_market_stall_loop.ogg"
)
const SFX_PICKUP := preload(
	"res://minigames-main/snatch_battle/assets/audio/sfx/sfx_meat_pickup_01.wav"
)
const SFX_ACCEPT := preload(
	"res://minigames-main/snatch_battle/assets/audio/sfx/sfx_basket_accept.wav"
)
const SFX_WRONG := preload(
	"res://minigames-main/snatch_battle/assets/audio/sfx/sfx_basket_wrong.wav"
)
const SFX_TRASH := preload(
	"res://minigames-main/snatch_battle/assets/audio/sfx/sfx_trash_accept.wav"
)
const SFX_STOLEN := preload(
	"res://minigames-main/snatch_battle/assets/audio/sfx/sfx_meat_stolen.wav"
)
