...
const DRIVER_PORTRAIT := preload("res://assets/art/characters/npc_driver/npc_driver_front.png")
const JEEPNEY_CRUISING_SOUND := preload("res://assets/audio/retro_filipino_pack/jeepney_cruising_subtle_loop.ogg")
...
func _ready() -> void:
	...
	audio_idle.stream = load("res://assets/audio/retro_filipino_pack/jeepney_idle_loop.wav")
	audio_idle.bus = "SFX"
