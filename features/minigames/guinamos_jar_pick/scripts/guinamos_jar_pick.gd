...
const ENDING_COLLECTIBLE: Texture2D = preload(
	"res://features/minigames/ending_sequence/assets/collectibles/collectible_guinamos_bag.png"
)
...
const MUSIC_PATH: String = (
	"res://features/minigames/guinamos_jar_pick/assets/audio/music/"
	+ "bgm_guinamos_deduction_loop.ogg"
)

const AMBIENCE_PATH: String = (
	"res://features/minigames/guinamos_jar_pick/assets/audio/ambience/"
	+ "amb_guinamos_market_stall_loop.ogg"
)

const SFX_ROOT: String = (
	"res://features/minigames/guinamos_jar_pick/assets/audio/sfx/"
)

const UI_SFX_ROOT: String = (
	"res://features/minigames/guinamos_jar_pick/assets/audio/ui/"
)
	...
	jars = [
		{
			...
			"main_texture": preload(
				"res://features/minigames/guinamos_jar_pick/assets/jars/main_jar_too_fresh.png"
			),
			"detail_texture": preload(
				"res://features/minigames/guinamos_jar_pick/assets/jars/guinamos_jar_too_fresh.png"
			),
			"is_correct": false,
			"wrong_dialogue": (
		...
		},
		{
			...
			"main_texture": preload(
				"res://features/minigames/guinamos_jar_pick/assets/jars/main_jar_too_salty.png"
			),
			"detail_texture": preload(
				"res://features/minigames/guinamos_jar_pick/assets/jars/guinamos_jar_too_salty.png"
			),
			"is_correct": false,
			"wrong_dialogue": (
		...
		},
		{
			...
			"main_texture": preload(
				"res://features/minigames/guinamos_jar_pick/assets/jars/main_jar_spoiled.png"
			),
			"detail_texture": preload(
				"res://features/minigames/guinamos_jar_pick/assets/jars/guinamos_jar_spoiled.png"
			),
			"is_correct": false,
			"wrong_dialogue": (
		...
		},
		{
			...
			"main_texture": preload(
				"res://features/minigames/guinamos_jar_pick/assets/jars/main_jar_watery.png"
			),
			"detail_texture": preload(
				"res://features/minigames/guinamos_jar_pick/assets/jars/guinamos_jar_watery.png"
			),
			"is_correct": false,
			"wrong_dialogue": (
		...
		},
		{
			...
			"name": "Aged Guinamos",
			"main_texture": preload(
				"res://features/minigames/guinamos_jar_pick/assets/jars/main_jar_aged.png"
			),
			"detail_texture": preload(
				"res://features/minigames/guinamos_jar_pick/assets/jars/guinamos_jar_aged.png"
			),
			"is_correct": true,
			"hints": {
