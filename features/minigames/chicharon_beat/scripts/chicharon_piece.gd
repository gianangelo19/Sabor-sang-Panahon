...
const OIL_SPLASH_SMALL_01: AudioStream = preload(
	"res://features/minigames/chicharon_beat/assets/audio/sfx/sfx_oil_splash_small_01.wav"
)

const OIL_SPLASH_SMALL_02: AudioStream = preload(
	"res://features/minigames/chicharon_beat/assets/audio/sfx/sfx_oil_splash_small_02.wav"
)

const CHICHARON_THROW_01: AudioStream = preload(
	"res://features/minigames/chicharon_beat/assets/audio/sfx/sfx_chicharon_throw_01.wav"
)

const CHICHARON_THROW_02: AudioStream = preload(
	"res://features/minigames/chicharon_beat/assets/audio/sfx/sfx_chicharon_throw_02.wav"
)

const CHICHARON_THROW_03: AudioStream = preload(
	"res://features/minigames/chicharon_beat/assets/audio/sfx/sfx_chicharon_throw_03.wav"
)

const CHICHARON_FLOAT: AudioStream = preload(
	"res://features/minigames/chicharon_beat/assets/audio/sfx/sfx_chicharon_float.wav"
)

const CHICHARON_BURN: AudioStream = preload(
	"res://features/minigames/chicharon_beat/assets/audio/sfx/sfx_chicharon_burn.wav"
)

const BURNT_JUMP: AudioStream = preload(
	"res://features/minigames/chicharon_beat/assets/audio/sfx/sfx_burnt_jump.wav"
)

const OIL_SPLASH_SMALL_TEXTURE: Texture2D = preload(
	"res://features/minigames/chicharon_beat/assets/effects/oil_splash_small.png"
)

const CHICHARON_SHADOW_TEXTURE: Texture2D = preload(
	"res://features/minigames/chicharon_beat/assets/effects/chicharon_shadow.png"
)
