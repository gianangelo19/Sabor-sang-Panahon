...
func _run() -> void:
	...
	_check(ProjectSettings.get_setting("application/run/main_scene") == "res://game/ui/menus/main_menu.tscn", "Project starts at the Main Menu")
	...
	game_state.start_new_game("res://game/worlds/la_paz/la_paz.tscn")
	...
	_check(loaded_scene == "res://game/worlds/la_paz/la_paz.tscn", "Continue restores the saved scene")
...
func _create_wake_up_effect() -> CanvasLayer:
	...
	effect.set_script(load("res://game/worlds/la_paz/apartment/wake_up.gd"))
	return effect
