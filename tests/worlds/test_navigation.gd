...
func _run() -> void:
	...
	var jeepney_script := load("res://game/props/vehicles/jeepney/jeepney_cutscene.gd")
	...
	var home_scene := load("res://game/worlds/la_paz/grandma_house/lapaz_home.tscn") as PackedScene
	var market_scene := load("res://game/worlds/la_paz/public_market/lapaz_public_market.tscn") as PackedScene
	var tindahan_scene := load("res://game/worlds/la_paz/tindahan/tindahan.tscn") as PackedScene
	...
	var map_script := load("res://game/ui/phone/map_view.gd")
